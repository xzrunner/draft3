...
public:
	FaceTranslateOP(const std::shared_ptr<pt0::Camera>& camera, const pt3::Viewport& vp,
		...
		const ee0::SelectionSet<pm3::Polytope::FacePtr>& selection, std::function<void()> update_cb);

protected:
	virtual bool QueryByPos(const sm::vec2& pos, const pm3::Polytope::FacePtr& face,
