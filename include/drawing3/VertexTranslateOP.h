...
class VertexTranslateOP : public MeshTranslateBaseOP<pm3::BrushVertexPtr>
{
public:
	VertexTranslateOP(const std::shared_ptr<pt0::Camera>& camera, const pt3::Viewport& vp,
		const ee0::SubjectMgrPtr& sub_mgr, const MeshPointQuery::Selected& selected,
		const ee0::SelectionSet<pm3::BrushVertexPtr>& selection, std::function<void()> update_cb);

protected:
	virtual bool QueryByPos(const sm::vec2& pos, const pm3::BrushVertexPtr& vert,
