...
class VertexSelectOP : public MeshSelectBaseOP<pm3::PointPtr>
{
public:
...
protected:
	...
	virtual pm3::PointPtr QueryByPos(int x, int y) const override;
	virtual void QueryByRect(const sm::irect& rect, std::vector<pm3::PointPtr>& selection) const override;
